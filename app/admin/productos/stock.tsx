...
export default function EntradaMercaderiaScreen() {
    ...
    const renderItem = ({ item }: { item: Producto }) => (
        <TouchableOpacity style={styles.card} onPress={() => abrirModalIngreso(item)}>
            <View style={styles.cardIcon}>
                <MaterialCommunityIcons name="cube-send" size={24} color="#2a8c4a" />
            </View>
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <View>
                    <Text style={styles.headerTitle}>Entrada de Mercadería</Text>
...
const styles = StyleSheet.create({
    ...
    cardStock: { alignItems: 'flex-end', minWidth: 60 },
